...
public class LinkedListDemo {
    public static void main(String[] args) {
        ...
        // Remove an element
        list.remove("Hello");
        System.out.println("LinkedList after removing 'Hello': " + list);

        // Remove all elements from another collection
        list.removeAll(additionalList);
        System.out.println("LinkedList after removeAll: " + list);

        // Retain only the elements that are contained in another collection
        List<String> retainList = Arrays.asList("World", "Java");
        list.retainAll(retainList);
        System.out.println("LinkedList after retainAll: " + list);
        ...
        list.add(0, "First");
        System.out.println("LinkedList after adding 'First' at index 0: " + list);
        ...
        System.out.println("LinkedList after setting 'Updated First' at index 0: " + list);

        // Remove an element at a specific index
        list.remove(0);
        System.out.println("LinkedList after removing element at index 0: " + list);
