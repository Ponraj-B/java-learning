...
class Main 
{
    ...
    public static void main(String[] args) 
    {
        ...
        String name = Main.findNameById(target).orElse("not_found"); // orElse method will check the returned value by the optional.of() or Optional.ofNullable() and if the value is null it will provide the static value from the orElse method
